...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){let r=new Float32Array(za),i=new q(0,1,0);return new xi({name:`SphericalGaussianBlur`,defines:{n:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new xi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(){return new xi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},gl=class extends dl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof xi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=vi.clone(e.uniforms),this.material=new xi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ml(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},_l=class extends dl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},vl=class extends dl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},yl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new Kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new gl(hl),this.copyPass.material.blending=0,this.timer=new ca}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}_l!==void 0&&(r instanceof _l?n=!0:r instanceof vl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},bl=class extends dl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},xl=`#define PI 3.14159265358979323846
...
}`,Sl=`// Declare the varying variable (same name and type in both shaders)
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUv;
...
void main() {
    ...
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,Cl={u_resolution:{value:new K},u_time:{value:0},u_normalRotation:{value:new Yt},u_uvShift:{value:new K},u_lightVec:{value:new q}},wl=class extends xi{constructor(e){super({uniforms:Cl,fragmentShader:xl,vertexShader:Sl}),this.uniforms.u_resolution.value=e}},Tl=`#define PI 3.14159265358979323846
...
}`,El=`// Declare the varying variable (same name and type in both shaders)
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUv;
...
void main() {
    ...
    // Standard projection formula required by Three.js
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,Dl={u_resolution:{value:new K},u_lightVec:{value:new q}},Ol=class extends xi{constructor(e){super({uniforms:Dl,fragmentShader:Tl,vertexShader:El}),this.uniforms.u_resolution.value=e}},kl=class{numTicks;bufferGeometry;positions;normals;constructor(e){this.numTicks=e,this.bufferGeometry=this.genQuadStrip()}getPositions(){return this.positions}getNormals(){return this.normals}getBufferGeometry(){return this.bufferGeometry}genIndexes(){let e=this.numTicks-1,t=[];for(let n=0;n<e*2;n+=2)t.push(n+0,n+2,n+1,n+1,n+2,n+3);return t}genUvs(){return new dr(new Float32Array(Array(2*this.numTicks).fill(0).flatMap((e,t)=>[t%2,Math.floor(t/2)/(this.numTicks/2)])),2)}genPositions(){return this.positions=new Float32Array(Array(2*this.numTicks*3).fill(0)),new dr(this.positions,3).setUsage(He)}genNormals(){return this.normals=new Float32Array(Array(2*this.numTicks*3).fill(0)),new dr(this.normals,3).setUsage(He)}genQuadStrip(){let e=new Er;return e.setAttribute(`position`,this.genPositions()),e.setAttribute(`normal`,this.genNormals()),e.setAttribute(`uv`,this.genUvs()),e.setIndex(this.genIndexes()),e}},Al=class{numTicks;group;quadStrips;constructor({numTicks:e,ribbonFaceMaterial:t,ribbonEdgeMaterial:n}){this.numTicks=e,this.quadStrips=[],this.group=new wn;for(let r=0;r<4;r++){let i=new kl(e);this.quadStrips.push(i),this.group.add(new Yr(i.getBufferGeometry(),r%2==0?n:t))}}getGroup(){return this.group}update({width:e,height:t,r1:n,r2:r,phi:i,theta:a}){for(let o=0;o<this.numTicks;o++){let s=o/this.numTicks,c=.01,l=s<c?Math.sqrt(1-(s/c-1)**2)*e(c):e(s);this.updateTick(o,{width:l,height:t(s),r1:n(s),r2:r(s),phi:i(s),theta:a(s)})}this.quadStrips.forEach(e=>{e.getBufferGeometry().getAttribute(`position`).needsUpdate=!0,e.getBufferGeometry().getAttribute(`normal`).needsUpdate=!0})}updateTick(e,{width:t,height:n,r1:r,r2:i,phi:a,theta:o}){let s=t/2,c=n/2,l=[this.toroidalToCartesian({r1:r,r2:i-s,phi:a,theta:o+c}),this.toroidalToCartesian({r1:r,r2:i+s,phi:a,theta:o+c}),this.toroidalToCartesian({r1:r,r2:i+s,phi:a,theta:o-c}),this.toroidalToCartesian({r1:r,r2:i-s,phi:a,theta:o-c})];for(let t=0;t<4;t++)this.quadStrips[t]?.getPositions().set([...l[(t+0)%4].toArray(),...l[(t+1)%4].toArray()],6*e),this.quadStrips[t]?.getNormals().set([...l[(t+0)%4].clone().sub(l[(t+3)%4]).normalize(),...l[(t+1)%4].clone().sub(l[(t+2)%4]).normalize()],6*e)}toroidalToCartesian({r1:e,r2:t,phi:n,theta:r}){let i=new q(1,0,0),a=new q(0,0,1);return new q(t,0,0).applyAxisAngle(a,n).applyAxisAngle(i,Math.PI/2).add(new q(e,0,0)).applyAxisAngle(a,r)}},jl={duration:8,easingDuration:4,settings:Rl({theta:({t:e})=>-20*e})},Ml={duration:4,easingDuration:2,settings:Rl({r1:({t:e,time:t})=>.5*Math.sin(10*(3*e+t))})},Nl={duration:4,easingDuration:2,settings:Rl({phi:({t:e})=>30*e})},Pl={duration:2,easingDuration:.3,settings:Rl({r2:({t:e,time:t})=>Math.max(0,-.3+Math.sin(10*(e+t)))})},Fl={duration:3,easingDuration:1.5,settings:Rl({phi:({i:e})=>-.7*(e*Math.PI/2)})},Il={duration:3,easingDuration:.3,settings:Rl({width:({t:e,time:t})=>.2*Math.sin(10*t+e*20),height:({t:e,time:t})=>.05*(1+Math.cos(10*t+e*20))})},Ll={width:()=>.4,height:()=>.25,r1:()=>6,r2:({t:e})=>2.5*(1-e),phi:({t:e,i:t})=>e*8*Math.PI+t*Math.PI/2,theta:({t:e})=>e*2*Math.PI*1.3+Math.PI};function Rl(e){let t=()=>0;return{width:e.width??t,height:e.height??t,r1:e.r1??t,r2:e.r2??t,phi:e.phi??t,theta:e.theta??t}}var zl=class{activePresets=[];options=[jl,Ml,Nl,Pl,Fl,Il];getTotalPresets(){return this.options.length}addSpecific(e,t){let n=this.options[e];this.activePresets.push({startTime:t,preset:n})}add(e){let t=this.options[Math.floor(Math.random()*this.options.length)];this.activePresets.push({startTime:e,preset:t})}calculateSettings(e){return this.activePresets=this.activePresets.filter(t=>t.startTime+t.preset.duration>e),this.activePresets.reduce((t,n)=>{let r=n.preset.settings,i=e-n.startTime,a=this.getEasingFactor(n,i);return{width:e=>t.width(e)+a*r.width(e),height:e=>t.height(e)+a*r.height(e),r1:e=>t.r1(e)+a*r.r1(e),r2:e=>t.r2(e)+a*r.r2(e),phi:e=>t.phi(e)+a*r.phi(e),theta:e=>t.theta(e)+a*r.theta({...e,time:i})}},Ll)}getEasingFactor(e,t){let n=e.preset.duration;return t<e.preset.easingDuration?Bl(t/e.preset.easingDuration):n-t<e.preset.easingDuration?Bl((n-t)/e.preset.easingDuration):1}};function Bl(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}var Vl=class{ribbons;group;ribbonFaceMaterial;ribbonEdgeMaterial;constructor({screenSize:e,numRibbons:t,numTicks:n}){this.ribbonFaceMaterial=new wl(e),this.ribbonEdgeMaterial=new Ol(e),this.group=new wn,this.ribbons=[];for(let e=0;e<t;e++){let e=new Al({numTicks:n,ribbonFaceMaterial:this.ribbonFaceMaterial,ribbonEdgeMaterial:this.ribbonEdgeMaterial});this.ribbons.push(e),this.group.add(e.getGroup())}}getMesh(){return this.group}animate({time:e,timeStepDuration:t,animationSettings:n}){let r=.5,i=t*r,a=e*r;for(let t=0;t<this.ribbons.length;t++)this.ribbons[t]?.update({width:r=>n.width({t:r,i:t,time:e}),height:r=>n.height({t:r,i:t,time:e}),r1:r=>n.r1({t:r,i:t,time:e}),r2:r=>n.r2({t:r,i:t,time:e}),phi:r=>n.phi({t:r,i:t,time:e}),theta:r=>n.theta({t:r,i:t,time:e})});this.getMesh().rotateZ(i),this.ribbonFaceMaterial.uniforms.u_time.value=e,this.ribbonFaceMaterial.uniforms.u_normalRotation.value=new Yt().makeRotationZ(-a);let o=new q(.4,-.8,-.1).normalize().applyAxisAngle(new q(0,0,1),-a);this.ribbonFaceMaterial.uniforms.u_lightVec.value=o,this.ribbonEdgeMaterial.uniforms.u_lightVec.value=o}},Hl=`#ifdef GL_ES
precision mediump float;
#endif
...
}`,Ul={u_resolution:{value:new K}},Wl=class extends xi{constructor(e){super({uniforms:Ul,fragmentShader:Hl,vertexShader:El,depthWrite:!1}),this.uniforms.u_resolution.value=e}},Gl=`#define noise_scale 900.0
...
}`,Kl=class{clickEvent=()=>{};keyPressEvents={};activeCanvas;start={x:0,y:0};constructor(e){this.activeCanvas=e,this.createEventTranslations()}registerClickEvent(e){this.clickEvent=e}registerKeyPress(e,t){this.keyPressEvents[e]=t}down(e){this.start=this.getInputPoint(e)}up(e){let t=this.getInputPoint(e);Math.abs(t.x-this.start.x)+Math.abs(t.y-this.start.y)<10&&this.clickEvent()}keyPressed(e){this.keyPressEvents[e]?.()}createEventTranslations(){this.activeCanvas.addEventListener(`pointerdown`,e=>this.down(e)),this.activeCanvas.addEventListener(`pointerup`,e=>this.up(e)),document.addEventListener(`keydown`,e=>this.keyPressed(e.key))}getInputPoint(e){return{x:e.pageX,y:e.pageY}}},ql=`uniform sampler2D tDiffuse;
uniform vec2 u_resolution;
...
void main() {
    ...
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,Yl={tDiffuse:{value:null},tDepth:{value:null},u_resolution:{value:new K(1,1)},uNormals:{value:new q(1,1,1)}},Xl=class extends xi{constructor(){super({uniforms:Yl,fragmentShader:ql,vertexShader:Jl})}},Zl=`uniform mat4 u_projectionMatrixInverse;

void main() {
    // Standard projection formula required by Three.js
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,Ql=`uniform mat4 u_projectionMatrixInverse;
...
}`,$l={u_projectionMatrixInverse:{value:new Yt}},eu=class extends xi{constructor(e){super({uniforms:$l,fragmentShader:Ql,vertexShader:Zl}),this.uniforms.u_projectionMatrixInverse.value=e}},tu=class extends dl{fsQuad;material;normalBuffer;normalMaterial;depthBuffer;depthMaterial;scene;camera;constructor({width:e,height:t,scene:n,camera:r}){super(),this.scene=n,this.camera=r,this.normalBuffer=new Kt(e,t,{format:E,type:v,minFilter:a,magFilter:a,generateMipmaps:!1,stencilBuffer:!1}),this.normalMaterial=new Ci,this.depthBuffer=new Kt(e,t,{format:E,type:v,minFilter:a,magFilter:a,generateMipmaps:!1,stencilBuffer:!1}),this.depthMaterial=new eu(r.projectionMatrixInverse),this.material=new Xl,this.fsQuad=new ml(this.material),this.material.uniforms.u_resolution.value=new K(e,t)}render(e,t,n){let r=this.scene.overrideMaterial;e.setRenderTarget(this.normalBuffer),this.scene.overrideMaterial=this.normalMaterial,e.render(this.scene,this.camera),e.setRenderTarget(this.depthBuffer),this.scene.overrideMaterial=this.depthMaterial,e.render(this.scene,this.camera),this.scene.overrideMaterial=r,this.material.uniforms.uNormals.value=this.normalBuffer.texture,this.material.uniforms.tDepth.value=this.depthBuffer.texture,this.material.uniforms.tDiffuse.value=n.texture,this.renderToScreen?e.setRenderTarget(null):(e.setRenderTarget(t),this.clear&&e.clear()),this.fsQuad.render(e)}};Z.myCustomNoise=Gl;var nu=document.getElementById(`spirals`);nu.width=window.innerWidth,nu.height=window.innerHeight;var ru=new K(nu.width,nu.height),iu=new Mn,au=new ea(75,ru.x/ru.y,.1,100),ou=new Hc({canvas:nu});ou.setSize(ru.x,ru.y),new Qc(au,ou.domElement);var su=new yl(ou),cu=new bl(iu,au),lu=new tu({width:ru.x,height:ru.y,scene:iu,camera:au});su.addPass(cu);var uu=new Kl(ou.domElement);su.addPass(lu);var du=new Vl({screenSize:ru,numRibbons:4,numTicks:1e3});iu.add(du.getMesh()),du.getMesh().rotateX(-1),au.add(new Yr(new fi(5e3,5e3),new Wl(ru)).translateZ(au.far*-.99)),iu.add(au);var fu=new na(new X(255,255,255),1,100,2);fu.position.set(10,10,10),iu.add(fu),au.position.set(0,0,15);var pu=new ca;pu.connect(document);var mu=pu.getElapsed(),hu=new zl;uu.registerClickEvent(()=>hu.add(pu.getElapsed()));for(let e=0;e<hu.getTotalPresets();e++)uu.registerKeyPress(String(e),()=>hu.addSpecific(e-1,pu.getElapsed()));function gu(e){pu.update();let t=pu.getElapsed(),n=t-mu;mu=t,du.animate({time:t,timeStepDuration:n,animationSettings:hu.calculateSettings(t)}),su.render()}ou.setAnimationLoop(gu);